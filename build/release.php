...
define('DEB_BASE', dirname(BUILD_DIR) . '/wp-cli-musty/');
define('DEB_SOURCE', DEB_BASE . 'opt/musty/');
define('RELEASE_ZIP', dirname(BUILD_DIR) . '/release/musty.zip');
define('RELEASE_JSON', dirname(BUILD_DIR) . '/release/musty.json');
define('MUSTY_JSON', '{
  "version": "%VERSION%",
  "download_link": "https:\/\/raw.githubusercontent.com\/Blobfolio\/musty\/master\/release\/musty.zip"
}
');
